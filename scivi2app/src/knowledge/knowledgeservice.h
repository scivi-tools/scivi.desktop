...
public:
    ...
    enum DepthStrategy { Direct, Recursive };

    enum LanguageStrategy { CPP, IGNORE };
    ...
    QList<Concept *> flatChildrenOf(Concept *parent,
                                    DepthStrategy strategy = Direct) const;
    QList<Concept *> partsOf(Concept *parent) const;
    QList<Concept *> subClassesOf(Concept *parent) const;
    QList<Concept *> hasRelationsWithSubType(int conceptId,
                                             Concept *parentType) const;
