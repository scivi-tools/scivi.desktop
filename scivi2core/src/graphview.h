...
signals:
    void inputClicked(NodeView *node, QQuickItem *socketView,
                      NodeSocket *socket);
    void outputClicked(NodeView *node, QQuickItem *socketView,
                       NodeSocket *socket);
...
private:
    ...
    QQuickItem *createFromComponent(QQmlComponent *component, Node *node,
                                    Edge *edge);
};
