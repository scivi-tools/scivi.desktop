...
public:
    ...
    explicit NodeSocket(int id, const QString &label, Type type, const NodeSocketType &dataType, Node* node, QObject *parent = nullptr);
    explicit NodeSocket(const NodeSocket& socket, Node* node, QObject *parent = nullptr);
