...
class Node : public QObject
{
    ...
    Q_PROPERTY(QQmlListProperty<scivi::diagram::NodeSocket> inputs READ inputsProp NOTIFY inputsChanged)
    Q_PROPERTY(QQmlListProperty<scivi::diagram::NodeSocket> outputs READ outputsProp NOTIFY outputsChanged)
    Q_PROPERTY(NodeView* view READ view)


public:
    explicit Node(QObject *parent = nullptr);
    explicit Node(QList<SharedNodeSocket> inputs, QList<SharedNodeSocket> outputs, QObject *parent = nullptr);
    ~Node();
    int id() const;
    float x() const;
    float y() const;
...
private:
    ...
    static NodeSocket *inputAt(QQmlListProperty<NodeSocket>* property, int index);
    static int outputCount(QQmlListProperty<NodeSocket>* property);
    static NodeSocket *outputAt(QQmlListProperty<NodeSocket>* property, int index);
