...
class DataNode : public Node {
    ...
    Q_PROPERTY(
        QObject *settingsModel READ settingsModel NOTIFY settingsModelChanged)
public:
    explicit DataNode(QObject *parent = nullptr);
    explicit DataNode(
        QString name, int conceptId = -1,
        scivi::filters::FilterFactory *implementationFactory = nullptr,
        QList<SharedSetting> settings = {}, QList<SharedNodeSocket> inputs = {},
